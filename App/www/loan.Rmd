...
**Step 2. Initial feature selection.** Within the step we carried out various activities so to deal with features that:

-   have significant presence of missing values,

-   are highly correlated

-   have significant number of levels which are not equally represented
...
The implementation of each of the 3 steps discussed, can be found at the following link: <https://github.com/branka1509/XAIFINANCE/tree/main/Credit%20risk%20modelling%20use%20case/notebooks>
